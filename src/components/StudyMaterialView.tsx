...
const StudyMaterialView = ({ material, type = 'study_material' }: StudyMaterialViewProps) => {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 px-3 sm:px-4">
      <div className="mb-6">
        ...
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 dark:text-white mb-4">{material.title}</h1>
      ...
      <Card className="p-4 sm:p-6 mb-8 shadow-lg border border-gray-100 dark:border-gray-700">
          ...
          <div className="flex flex-col space-y-2 w-full md:w-auto">
            {user && (
              <Button 
                ...
                className={`flex items-center justify-center px-4 py-3 rounded-lg transition-colors tap-target ${
            ...
            <Button 
              ...
              className="flex items-center justify-center px-4 py-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg transition-colors tap-target"
            >
            ...
            {isPastPaperMaterial && (
              <Button 
                ...
                className="flex items-center justify-center px-4 py-3 bg-amber-600 hover:bg-amber-700 text-white rounded-lg transition-colors tap-target"
              >
                <FileText className="h-4 w-4 mr-2" />
                Download Solution
              </Button>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700">
        <div className="p-4 sm:p-6">
          ...
          <div className="min-h-[420px] sm:min-h-[600px] max-h-[800px] overflow-hidden">
            <EnhancedPdfViewer
              fileUrl={material.file_url || "https://www.africau.edu/images/default/sample.pdf"}
              title={material.title}
              height={window.innerWidth < 640 ? 480 : 700}
