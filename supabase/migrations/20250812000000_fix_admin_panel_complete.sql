-- Complete Admin Panel Fix Migration
-- This migration fixes all issues with the admin panel functionality
...
-- ===========================================
-- 11. INSERT DEFAULT ADMIN USER (if needed)
-- ===========================================

-- This will create an admin user if you provide the email
