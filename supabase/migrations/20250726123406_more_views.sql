...
-- Create admin user record in the users table (commented out due to database reset)
...
-- Create student profile for the admin user (commented out due to database reset)
