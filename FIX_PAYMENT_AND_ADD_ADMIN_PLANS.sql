...
-- ===========================================
-- STEP 2: Fix Storage Bucket Issues
-- ===========================================
...
SELECT 'Tables status:' as info, 
       CASE 
           ...
           THEN '✅ payment_requests table exists'
           ELSE '❌ payment_requests table missing'
       END as status;
...
SELECT 'Storage bucket status:' as info,
       CASE 
           ...
           THEN '✅ payment-receipts bucket exists'
           ELSE '❌ payment-receipts bucket missing'
       END as status;

-- Check admin functions
SELECT 'Admin functions status:' as info,
...
-- SUMMARY
-- ===========================================
-- ✅ Fixed payment request table structure and policies
-- ✅ Created storage bucket for payment receipts
-- ✅ Added comprehensive admin subscription plan management
-- ✅ Created admin functions for CRUD operations on plans
-- ✅ Added subscription plan statistics
-- ✅ Set up proper RLS policies for admin access
-- ✅ All functions are properly secured with admin checks
